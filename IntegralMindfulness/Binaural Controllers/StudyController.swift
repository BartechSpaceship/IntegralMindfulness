...
class StudyController: UIViewController {
    ...
    let binouralTitle = ["Memory", "Focus/Awareness","Concentration", "Study Aid"]
  let binouralImage = [
               UIImage(named: "study"),
           ...
           let binauralDyscription = ["4Hz 210-214", "14Hz 313-327", "9.33Hz 230-239.33", "12Hz 317-329"]
       ...
       extension StudyController: UICollectionViewDataSource, UICollectionViewDelegate {
