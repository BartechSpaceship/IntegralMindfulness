...
class SleepController: UIViewController{
    ...
    let binouralTitle = ["Sleep", "Lucid dreaming", "Wellbeing", "Relaxation(Less sleep required)", "Restful Sleep", "Relief"]
   ...
   let binouralImage = [
           ...
           let binauralDyscription = ["2.0Hz TBD", "1.5Hz TBD", "1Hz 56-57", "5Hz 220-225", "3.4Hz 126-130.4", "10Hz 280-290" ]
    ...
    extension SleepController:  UICollectionViewDataSource, UICollectionViewDelegate  {
